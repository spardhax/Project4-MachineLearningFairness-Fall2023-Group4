...
def _hinge_loss(w, df_new, y_label, C):
    ...
    """
    This function is used to calculate the hinge loss for a linear model with weights w.
    """
...
def _logistic_loss(w, X, y, return_arr=None):
    ...
    This function is used to calculate the logistic loss for a logistic regression model with weights w.
...
def _logistic_loss_l2_reg(w, X, y, lam=None):
    ...
    """
    This function is used to calculate the logistic loss with L2 regularization for a logistic regression model with
    weights w.
    """
